...
export const Card = ({ title, value, icon: Icon, trend, color, isPercentage, type }) => (
...
const SummaryCards = ({ data, manualExpenses = { salary: 0, daily: 0 } }) => {
    const stats = useMemo(() => {
        ...
        return { sales, expenses, netProfit, margin };
    }, [data, manualExpenses]);

    return (
        <div className="grid-cols-4" style={{ marginBottom: '2rem' }}>
            <Card title="Total Sales" value={stats.sales} icon={IndianRupee} color="59, 130, 246" type="sales" />
