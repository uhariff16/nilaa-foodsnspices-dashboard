                    ...
                    for (let i = startRow; i < jsonData.length; i++) {
                        ...
                        if (row[0] && row[1]) {
                            ...
                            if (date && mat && weight > 0) {
                                productionData.stockIn.push({ date, material: mat, weight, source: sheetName });
                            }
                        }
                        ...
                        if (row[4] && row[5]) {
                            ...
                            if (date && mat && weight > 0) {
                                productionData.preProduction.push({ date, material: mat, weight, source: sheetName });
                            }
                        }
                        ...
                        if (row[8] && row[9]) {
                            ...
                            if (date && mat && weight > 0) {
                                productionData.postProduction.push({ date, material: mat, weight, source: sheetName });
                            }
                        }
                    }
                });
