...
const Dashboard = (props) => {
    ...
    const [salesViewMode, setSalesViewMode] = useState('details'); // 'details' | 'summary'
                ...
                <div className="glass-panel" style={{ padding: '1.5rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            <button
                                onClick={() => setSalesViewMode(v => v === 'details' ? 'summary' : 'details')}
                                className="btn-secondary"
                            >
                                {salesViewMode === 'details' ? 'View Summary' : 'View Details'}
                            </button>
                        </div>
                    </div>
                    {salesViewMode === 'details' ? (
                        <TransactionTable transactions={salesTransactions} type="sales" />
                    ) : (
                        <SalesSummaryTable transactions={salesTransactions} />
                    )}
                </div>
            )}
