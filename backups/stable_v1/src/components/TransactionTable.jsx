                    ...
                    <tbody>
                        {transactions.map((t, i) => (
                            <tr key={i} style={{ borderBottom: '1px solid var(--glass-border)' }}>
                                ...
                                <td style={{ padding: '1rem', textAlign: 'right', fontWeight: 600, color: type === 'Sales' ? '#10b981' : '#ef4444' }}>
                                    {type === 'Sales' ? '+' : '-'}
                                    {new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR' }).format(t.parsedAmount)}
                                </td>
                            </tr>
                        ))}
