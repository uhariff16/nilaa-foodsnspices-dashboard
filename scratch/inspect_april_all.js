...
async function main() {
    ...
    const aprilTxns = data.filter(t => t.date && t.date.includes('-04-'));
    console.log("April transactions count:", aprilTxns.length);
    console.log("Sample April transactions:", aprilTxns.slice(0, 10));
}
