...
import { DollarSign, Package, Save, CheckCircle, AlertCircle, RefreshCw, PlusCircle } from 'lucide-react';
...
const ManualEntry = () => {
    ...
    return (
        <div className="admin-wrapper" style={{ minHeight: '600px', paddingBottom: '4rem' }}>
            <div className="admin-header" style={{ maxWidth: '48rem', width: '100%' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                    ...
                    <div>
                        ...
                        <p className="admin-subtitle">Unified portal for manual data entry.</p>
                    </div>

                    {/* Tab Navigation */}
                    <div className="btn-toggle-group" style={{ marginTop: '0.5rem', flexWrap: 'wrap', justifyContent: 'center', gap: '0.5rem' }}>
                        <button
            ...
            <div style={{ maxWidth: '48rem', width: '100%', margin: '0 auto' }}>
                <div style={{ background: 'rgba(255, 255, 255, 0.02)', border: '1px solid var(--glass-border)', borderRadius: '0.75rem', padding: '2rem' }}>
